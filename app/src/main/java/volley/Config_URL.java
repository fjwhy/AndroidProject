...
{
	private static String base_URL = "http://istefa.co.id/";		//Default configuration for WAMP - 80 is default port for WAMP and 10.0.2.2 is localhost IP in Android Emulator
	// Server user login url
	public static String URL_LOGIN = base_URL+"projectmine/login.php";

	// Server user register url
	public static String URL_REGISTER = base_URL+"projectmine/login.php";

	// Server user register url
	public static String URL_insert_project = base_URL+"projectmine/insert_project.php";

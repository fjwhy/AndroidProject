...
public class my_project extends AppCompatActivity {
    ...
    private String TAG = my_project.class.getSimpleName();

    private ProgressDialog pDialog;
    private ListView lv;

    // URL to get contacts JSON
    private static String url = "http://istefa.co.id/projectmine/get_my_project_rev.php";
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(my_project.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        String name = c.getString("AndroidNames");
                        String email = c.getString("category");
                        String address = c.getString("ImagePath");
